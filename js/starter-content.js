...
const STARTER_EXERCISES = [
  ...
  { name: 'Push-Up', muscle_group: 'Chest', category: null },
  ...
  { name: 'Pull-Up', muscle_group: 'Back', category: null },
  ...
  { name: 'Dip', muscle_group: 'Arms', category: null },
  ...
  { name: 'Glute Bridge', muscle_group: 'Glutes', category: null },
  { name: 'Bulgarian Split Squat', muscle_group: 'Glutes', category: 'Compound' },
  { name: 'Plank', muscle_group: 'Core', category: null },
  { name: 'Hanging Leg Raise', muscle_group: 'Core', category: null },
  { name: 'Cable Crunch', muscle_group: 'Core', category: 'Isolation' },
  { name: 'Russian Twist', muscle_group: 'Core', category: null },
  ...
  { name: 'Burpee', muscle_group: 'Full Body', category: null },
]
